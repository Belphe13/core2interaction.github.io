...
## Schedule
- Demo: [JSON with Filters](https://github.com/lilanyang/lilanyang.github.io/tree/main/json-demo-filters)
- Work Time

## Homework
- Continue to work on Project 2, DUE 4/4

## JSON Template with Filters
```html
<!DOCTYPE html>
<html lang="en">
<head>
